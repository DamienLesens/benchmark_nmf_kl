...
class Solver(BaseSolver):
    """
    HALS for Frobenius loss from A. Cichocki and A.-H. Phan, “Fast local algorithms for large scale nonnegative matrix and tensor factorizations,”
    """
    name = "HALS"
