...
exp_name = "full_simulated_low_rank_f"
...
time_groups = {'1': ["simulated[estimated_rank=10,low_rank=True,m_dim=200,n_dim=200,noise_type=poisson,snr=100,true_rank=10]"],
                '4': ["simulated[estimated_rank=20,low_rank=True,m_dim=500,n_dim=500,noise_type=poisson,snr=100,true_rank=20]",]}
